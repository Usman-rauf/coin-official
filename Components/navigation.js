...
import moon from "../public/Assests/moon.png";
...
<nav class="bg-white border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-gray-800">
  ...
  <div class="flex items-center md:order-2">
      ...
      <div class="hidden z-50 my-4 text-base list-none bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600" id="dropdown" data-popper-reference-hidden="" data-popper-escaped="" data-popper-placement="top" style={{position: "absolute", margin: '0px', transform: 'translate(956px, 1159px)'}}>
        <div class="py-3 px-4">
